...
- Release workflow: signed APKs are built in CI from repository secrets, the signing certificate is checked against the published fingerprint, and a `dry_run` mode signs without publishing.
